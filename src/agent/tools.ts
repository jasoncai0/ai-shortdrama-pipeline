...
export const buildAgentTools = (
  ...
  registry.register({
    name: 'run_stages',
    description:
      '按顺序运行一个或多个管线 stage。可用: plan, assets, refs, wardrobe, sheets, shots, camera-check, voice-check, prompts, images, videos, dub, export, grade, music, intro-cards, subtitles, cover。gate 类 stage 由人负责，不给 agent。',
